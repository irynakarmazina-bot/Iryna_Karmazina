...
#   «Море + авто» = «фрахт+ТЕО+авто» (ТЕО мається на увазі); з 30.07 користувачка
#     обрала єдиний стиль назв, тому обидва написання («Море + авто» і «Фрахт+ТЕО+Авто»)
#     ведуть в один варіант «фрахт+ТЕО+авто», а підпис «Море + авто» прибрано зі списку;
...
MAP = {
    "Море + авто": "фрахт+ТЕО+авто",
    "Фрахт+ТЕО+Авто": "фрахт+ТЕО+авто",
    "Море": "фрахт",
    "ТЕО+АВТО": "ТЕО+авто",
