...
#   1) якщо в угоді заповнена ДАТА ВИКОНАННЯ РОБІТ — вантаж доставлено;
#   2) якщо в платформі людина вже поставила «Вантаж доставлено» — не понижуємо.
...
def map_deal(d, names, allowed_lines, allowed_kinds, allowed_statuses=frozenset()):
    ...
    if d10(d.get(WORKS_DONE_FIELD)):         # роботи виконані → вантаж доставлено
        stage = DELIVERED
