...
# 🛑 ДИВИТИСЬ ТІЛЬКИ НА ВИД ОПЛАТИ. НЕ на реквізит «Организация».
# Дослівно, користувачка 25.08.2026 (двічі): «вид оплати Банк Юнітекс Форвардинг»,
# «не дивись на організацію, а дивись на вид оплати… Оплата З або НА Банк Юнітекс
# Форвардинг — це оплати ЮФ».
# Тобто:
#   * доходний рахунок із видом оплати «Банк Юнітекс Форвардинг» (гроші прийшли НА нього)
#     — це дохід ЮФ, у розрахунок не береться;
#   * витратний рахунок із тим самим видом оплати (гроші пішли З нього)
#     — це витрата ЮФ, у розрахунок не береться.
# Реквізит «Организация» для цього НЕ використовується взагалі: перевірено 25.08.2026,
# у ВСІХ 353 доходних і 1171 витратному рахунку там стоїть «Юнітекс Ейч-Ді», тож
# за цим полем Форвардинга не видно, і спроба фільтрувати по ньому нічого не давала.
