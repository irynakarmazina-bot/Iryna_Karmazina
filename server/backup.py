...
def main():
    ...
    try:
        ...
        # 7. ІНСТРУКЦІЮ ВІДНОВЛЕННЯ ТУТ НЕ ЧІПАЄМО — рішення користувачки 10.08.2026:
        #    «її не треба ніде перезаписувати, те, що вона збережена, вже достатньо.
        #     Якщо буде в неї щось додаватися — тоді перезапишемо».
        #    Файл `ЯК-ВІДНОВИТИ.md` уже лежить у /root/backups і вже вивантажений
        #    на Google Drive; rclone бачить, що він не змінився, і не чіпає його.
        #    Прибирання старих копій його теж не займе — NAME_RE його не впізнає.
        #    ⚠️ Наступним сесіям: НЕ повертати сюди автоматичне копіювання.
        #    Оновлювати інструкцію треба свідомо й вручну, коли справді змінилась
        #    процедура відновлення — тоді покласти новий файл у /root/backups
        #    і один раз вивантажити: rclone copy /root/backups/ gdrive:unitex-backups/
