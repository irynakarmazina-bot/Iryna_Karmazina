...
PAGES.accounting = async () => {
  ...
  <div class="card">
    ...
    <div class="note" style="margin-top:12px">
      <b>Як рахується:</b> <b>залишок на рахунку</b> = надходження від клієнта мінус
      фактично <b>оплачені</b> витрати (в УО) — це «Залишок» в Експедиторі; неоплачені
      рахунки не віднімаються, бо грошима ще не пішли.
