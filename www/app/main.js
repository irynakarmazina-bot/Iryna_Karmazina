...
PAGES.accounting = async () => {
  ...
  // Сортування: типово за ДАТОЮ ОПЛАТИ ВІД КЛІЄНТА, НАЙСТАРІШІ ЗВЕРХУ (вимога користувачки
  // 25.08.2026 — спершу зробила навпаки, вона поправила). Клік по заголовку сортує за цією
  // колонкою, повторний клік — навпаки. Угоди без дати оплати завжди в кінці.
  const COLS = [
