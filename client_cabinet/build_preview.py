...
function routeHtml(r){
  ...
  const ST_STEP = {
    ...
    /* «На перевалці» — вантаж ще пливе, просто зараз на проміжному терміналі.
  ...
  const ST_ORDER = ["Букінг","Виконується","Стафіровка","В порту відправлення",
    "Завантажений на судно","В морі","На перевалці","В порту призначення","Вивантажений в порту прибуття",
